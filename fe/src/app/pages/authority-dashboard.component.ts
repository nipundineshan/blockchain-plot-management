...
export class AuthorityDashboardComponent {
  ...
  stats = [
    { label: "Pending Approvals", value: "18", icon: 'heroClock', color: "yellow" },
    { label: "Approved Today", value: "32", icon: 'heroCheckCircle', color: "green" },
    { label: "Rejected", value: "5", icon: 'heroExclamationTriangle', color: "red" },
    { label: "Total Verified", value: "1,247", icon: 'heroShieldCheck', color: "blue" }
  ];
